...
export default {
    "bizOrgCreditRecordInfoBeforeLoadBiz": (_this) => {
        let saveGroupId = "ORG_INFO";
    ...
    "bizOrgCreditRecordInfoAfterLoadBiz": (_this) => {
        let saveGroupId = "ORG_INFO";
    ...
    "bizOrgCreditRecordInfoPageActived": (_this) => {
        let saveGroupId = "ORG_INFO";
    ...
    "bizOrgCreditRecordInfoValidate": (_this) => {
        //todo
        let saveGroupId = "ORG_INFO";
    ...
    "bizOrgCreditRecordInfoBeforeSave": (_this, params) => {
        let saveGroupId = "ORG_INFO";
    ...
    bizOrgCreditRecordInfoNodeAddModuleFinished: (_this, module) => {
        module.FIELDS.RECORD_SOURCE.labelWidth = "240";
    },
    bizOrgCreditRecordInfoNodeDeleteModuleFinished: (_this, deleteObj) => {
        _this.$nextTick(() => {
            let saveGroupId = "ORG_INFO";
            let CREDIT_RECORD_INFO = _this.groupDatas[saveGroupId].CREDIT_RECORD_INFO;
