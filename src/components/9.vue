<template> 
              ...
              <div style="margin-top: 200px;">
                      ...
                      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
                             ...
                             margin-bottom: 30px;">
                                  <el-input class="cyberpunk" type="password" v-model="ruleForm.transactionpw" style="flex: 1;" 
                                  autocomplete="new-password"></el-input>
                              </el-form-item>
  
                              <el-form-item label="交易密码确认" label-width="150px" prop="transactionpwconfirmation" style="width: 500px;
                              margin-bottom: 30px;">
                                  <el-input class="cyberpunk" type="password" v-model="ruleForm.transactionpwconfirmation" style="flex: 1;"></el-input>
                              </el-form-item>
  
                              <el-form-item label="资金密码" label-width="150px" prop="fundpw" style="width: 500px;
                              margin-bottom: 30px;">
                                  <el-input class="cyberpunk" type="password" v-model="ruleForm.fundpw" style="flex: 1;"
                                  autocomplete="new-password"></el-input>
                              </el-form-item>
                              ...
                              margin-bottom: 30px;">
                                  <el-input class="cyberpunk" type="password" v-model="ruleForm.fundpwconfirmation" style="flex: 1;"></el-input>
                              </el-form-item>
  ...
  export default {
    ...
    mounted() {
     ...
     signSucc.src = require("../asset/video/10.wav")
     signSucc.play()
    },
    data() {
      return {
